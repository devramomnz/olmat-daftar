...
export default function SideBarDaftar(props: IProps) {
  ...
  return (
    ...
    >
      <motion.ul className="fixed top-0 z-30 pt-20 pb-10 lg:block w-3/4 h-screen overflow-y-scroll no-scrollbar overflow-x-hidden bg-white md:w-1/3 lg:w-64 drop-shadow-lg ">
